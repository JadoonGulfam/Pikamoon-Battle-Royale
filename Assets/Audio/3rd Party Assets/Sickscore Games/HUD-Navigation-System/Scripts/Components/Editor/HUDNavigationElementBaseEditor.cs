		...
		if (!_hideSettings) {
			...
			if (_pRadarPrefab.objectReferenceValue != null) {
				...
				if (_radar_) {
					...
					EditorGUILayout.PropertyField (_pIgnoreRadarRadius, new GUIContent ("Ignore Radius", "EnableCollider, if this element should always be visible within the radar. Useful for e.g. quest markers."));
					EditorGUILayout.PropertyField (_pIgnoreRadarScaling, new GUIContent("Ignore Radar Scaling", "EnableCollider, if this element should ignore the radar scaling feature."));
					EditorGUILayout.PropertyField (_pIgnoreRadarFading, new GUIContent("Ignore Radar Fading", "EnableCollider, if this element should ignore the radar fading feature."));
					...
					GUILayout.Space (4); // SPACE
					EditorGUILayout.BeginVertical (boxStyle);
					_pUseRadarHeightSystem.boolValue = EditorGUILayout.ToggleLeft (new GUIContent ("EnableCollider Height System", "EnableCollider if you want to use the height system on this element."), _pUseRadarHeightSystem.boolValue, subHeaderStyle);
			...
			if (_pCompassBarPrefab.objectReferenceValue != null) {
				...
				if (_compassBar_) {
					...
					if (_pHideInCompassBar.boolValue && showHelpboxes) {
						...
						EditorGUILayout.PropertyField (_pIgnoreCompassBarRadius, new GUIContent ("Ignore Radius", "EnableCollider, if this element should always be visible within the compass bar. Useful for e.g. quest markers."));
					...
					GUILayout.Space (4); // SPACE
					EditorGUILayout.BeginVertical (boxStyle);
					_pUseCompassBarDistanceText.boolValue = EditorGUILayout.ToggleLeft (new GUIContent ("EnableCollider Distance Text", "EnableCollider to show a text with the actual distance next to the element."), _pUseCompassBarDistanceText.boolValue, subHeaderStyle);
			...
			if (_pIndicatorPrefab.objectReferenceValue != null) {
				...
				if (_indicator_) {
					GUILayout.Space (4); // SPACE
					// CONTENT BEGIN
					EditorGUILayout.PropertyField (_pShowIndicator, new GUIContent ("Show Indicator", "EnableCollider, if you want to use the indicator feature on this element. Needs to be enabled on the HUD Navigation System component."));
					if (_pShowIndicator.boolValue) {
						EditorGUILayout.PropertyField (_pShowOffscreenIndicator, new GUIContent ("Show Offscreen Indicator", "EnableCollider, if you want to use the offscreen indicator feature on this element. Needs to be enabled on the HUD Navigation System component."));
						...
						EditorGUILayout.PropertyField (_pIgnoreIndicatorRadius, new GUIContent ("Ignore Radius", "EnableCollider, if the indicator of this element should always be visible. Useful for e.g. quest markers."));
						EditorGUILayout.PropertyField (_pIgnoreIndicatorHideDistance, new GUIContent ("Ignore Hide Distance", "EnableCollider, if the indicator of this element should ignore the hide distance. Useful for e.g. pickup items."));
						EditorGUILayout.PropertyField (_pIgnoreIndicatorScaling, new GUIContent ("Ignore Distance Scaling", "EnableCollider, if the indicator should ignore the distance scaling feature. Useful for e.g. pickup items."));
						EditorGUILayout.PropertyField (_pIgnoreIndicatorFading, new GUIContent ("Ignore Distance Fading", "EnableCollider, if the indicator should ignore the distance fading feature. Useful for e.g. POI's or quest markers."));
						if (showHelpboxes) {
						...
						GUILayout.Space (4); // SPACE
						EditorGUILayout.BeginVertical (boxStyle);
						_pUseIndicatorDistanceText.boolValue = EditorGUILayout.ToggleLeft (new GUIContent ("EnableCollider Distance Text", "EnableCollider to show a text with the actual distance next to the element."), _pUseIndicatorDistanceText.boolValue, subHeaderStyle);
						if (_pUseIndicatorDistanceText.boolValue) {
							GUILayout.Space (4); // SPACE
							EditorGUILayout.PropertyField (_pShowOffscreenIndicatorDistance, new GUIContent ("Show Offscreen Distance", "EnableCollider, if you want to show the offscreen distance text."));
			...
			if (_pMinimapPrefab.objectReferenceValue != null) {
				...
				if (_minimap_) {
					...
					EditorGUILayout.PropertyField (_pIgnoreMinimapRadius, new GUIContent ("Ignore Radius", "EnableCollider, if this element should always be visible within the minimap. Useful for e.g. quest markers."));
					EditorGUILayout.PropertyField (_pIgnoreMinimapScaling, new GUIContent("Ignore Minimap Scaling", "EnableCollider, if this element should ignore the minimap scaling feature."));
					EditorGUILayout.PropertyField (_pIgnoreMinimapFading, new GUIContent("Ignore Minimap Fading", "EnableCollider, if this element should ignore the minimap fading feature."));
					...
					GUILayout.Space (4); // SPACE
					EditorGUILayout.BeginVertical (boxStyle);
					_pUseMinimapHeightSystem.boolValue = EditorGUILayout.ToggleLeft (new GUIContent ("EnableCollider Height System", "EnableCollider if you want to use the height system on this element."), _pUseMinimapHeightSystem.boolValue, subHeaderStyle);
