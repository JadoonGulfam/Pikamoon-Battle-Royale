...
{
	Material.PreshaderBuffer[0] = float4(2.000000,-0.000977,-0.000488,25.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(-0.000326,-0.000244,-0.000195,-0.000163);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.468750,0.954914,1.000000,20.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.250000,0.750000,0.250000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,6.126106);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.447059,0.000000,0.035294,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.750000,0.250000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.133333,0.305882,0.133333,-0.000977);//(Unknown)
