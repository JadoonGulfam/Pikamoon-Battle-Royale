Shader "Unreal/white_wood_planks_colour_MI"
{
    Properties
    {
		...
		Material_Texture2D_1( "concrete_damage_normal_T", 2D ) = "white" {}
		Material_Texture2D_2( "concrete_damage_colour_T", 2D ) = "white" {}
		Material_Texture2D_3( "caustics_masks_T", 2D ) = "white" {}
		Material_Texture2D_4( "Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "AO_Rough_Metal", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "white_wood_planks_colour_MI.hlsl"
