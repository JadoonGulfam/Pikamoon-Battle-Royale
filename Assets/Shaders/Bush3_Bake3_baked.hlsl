...
{
	MaterialCollection0.Vectors[0] = float4(0.010000,0.000000,-321767850891134611812330166550528.000000,0.000000);//WindStrength,,,
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local15 = DERIV_BASE_VALUE(Local14).rgb;
	FWSVector3 Local16 = TransformLocalPositionToWorld(Parameters, MaterialFloat3(0.00000000,0.00000000,0.00000000).rgb);
	FWSScalar Local17 = WSDot(Local16, WSPromote(MaterialFloat3(0.00000000,1.00000000,0.00000000).rgb));
	FWSScalar Local18 = WSDivideByPow2(Local17, 4.00000000);
	FWSVector3 Local19 = WSDivideByPow2(GetObjectWorldPosition(Parameters), ((MaterialFloat3)4.00000000));
	FWSVector3 Local20 = WSAdd(((MaterialFloat3)View.GameTime), Local19);
	FWSVector3 Local21 = WSAdd(MakeWSVector(WSGetComponent(Local18, 0),WSGetComponent(Local18, 0),WSGetComponent(Local18, 0)), Local20);
	FWSVector3 Local22 = WSMultiplyByPow2(Local21, ((MaterialFloat3)0.25000000));
	FWSVector3 Local23 = WSMultiply(Local22, ((MaterialFloat3)6.28318548));
	MaterialFloat3 Local24 = WSSin(Local23);
	MaterialFloat3 Local25 = (DERIV_BASE_VALUE(Local24) + ((MaterialFloat3)0.25000000));
	MaterialFloat3 Local26 = (DERIV_BASE_VALUE(Local25) / ((MaterialFloat3)120.00000000));
	MaterialFloat3 Local27 = (DERIV_BASE_VALUE(Local26) * ((MaterialFloat3)6.28318548));
	MaterialFloat Local28 = DERIV_BASE_VALUE(Local27).x;
	MaterialFloat4 Local29 = MaterialCollection0.Vectors[1];
	MaterialFloat3 Local30 = normalize(MaterialFloat3(MaterialFloat2(Local29.rgba.xyz.r,Local29.rgba.xyz.g),Material.PreshaderBuffer[1].x));
	MaterialFloat4 Local31 = MaterialFloat4(DERIV_BASE_VALUE(Local30),DERIV_BASE_VALUE(Local28));
	FWSVector3 Local32 = GetWorldPosition(Parameters);
	FWSVector3 Local33 = MakeWSVector(WSGetX(DERIV_BASE_VALUE(Local32)), WSGetY(DERIV_BASE_VALUE(Local32)), WSGetZ(DERIV_BASE_VALUE(Local32)));
	MaterialFloat3 Local34 = RotateAboutAxis(DERIV_BASE_VALUE(Local31),Local16,DERIV_BASE_VALUE(Local33));
	MaterialFloat3 Local35 = WSMultiplyDemote(DERIV_BASE_VALUE(Local33), GetWorldToInstance(Parameters));
	MaterialFloat3 Local36 = CustomExpression0(Parameters);
	MaterialFloat3 Local37 = (DERIV_BASE_VALUE(Local35) - Local36);
	MaterialFloat3 Local38 = CustomExpression1(Parameters);
	MaterialFloat3 Local39 = (Local38 - Local36);
	MaterialFloat3 Local40 = (Local37 / Local39);
	MaterialFloat3 Local41 = (Local34 * ((MaterialFloat3)Local40.b));
	MaterialFloat3 Local42 = (DERIV_BASE_VALUE(Local15) + Local41);
	return Local42;;
