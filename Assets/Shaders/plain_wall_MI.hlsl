...
{
	Material.PreshaderBuffer[0] = float4(2.000000,-0.001909,-0.002156,25.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.100000,0.000000,0.008504,0.500000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.050000,-0.050000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.373529,0.498039,0.381311,-0.000651);//(Unknown)
