...
{
	Material.PreshaderBuffer[0] = float4(-0.010000,-0.000977,-0.040000,0.010000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(-0.001302,0.040000,0.040000,-0.000781);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.010000,-0.040000,-0.000651,-0.010000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,2.000000,-1.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(-1.000000,0.007843,0.035294,0.035294);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.029885,0.121346,0.135417,-0.000651);//(Unknown)
	Material.PreshaderBuffer[7] = float4(-0.000488,-0.000391,-0.000326,0.750000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.003333,2.578125,4.289887,5.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.050000,1.100000,0.080000,3.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-2.000000,0.750000,0.000000,0.000000);//(Unknown)
