Shader "Unreal/ChestBottom_Bake1"
{
    Properties
    {
		...
		Material_Texture2D_0( "ChestBottom_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "ChestBottom_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "ChestBottom_Bake1_pbr_metalness", 2D ) = "white" {}
		Material_Texture2D_3( "ChestBottom_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_4( "ChestBottom_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "ChestBottom_Bake1.hlsl"
