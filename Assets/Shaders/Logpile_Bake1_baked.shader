Shader "Unreal/Logpile_Bake1_baked"
{
    Properties
    {
		...
		Material_Texture2D_0( "Logpile_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "Logpile_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Logpile_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_3( "Logpile_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Logpile_Bake1_baked.hlsl"
