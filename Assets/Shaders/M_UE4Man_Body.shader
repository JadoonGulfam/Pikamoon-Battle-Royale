Shader "Unreal/M_UE4Man_Body"
{
    Properties
    {
		...
		Material_Texture2D_1( "UE4_Mannequin_MAT_MASKA", 2D ) = "white" {}
		Material_Texture2D_2( "T_ML_Aluminum01", 2D ) = "white" {}
		Material_Texture2D_3( "T_ML_Rubber_Blue_01_D", 2D ) = "white" {}
