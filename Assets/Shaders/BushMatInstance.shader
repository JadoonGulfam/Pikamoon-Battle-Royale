Shader "Unreal/BushMatInstance"
{
    Properties
    {
		...
		Material_Texture2D_0( "BushPlane_Bake1_pbrs2a_normal", 2D ) = "white" {}
		Material_Texture2D_1( "BushPlane_Bake1_pbrs2a_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "BushPlane_Bake1_pbrs2a_specular", 2D ) = "white" {}
		Material_Texture2D_3( "BushPlane_Bake1_pbrs2a_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "BushPlane_Bake1_pbrs2a_sss", 2D ) = "white" {}
		Material_Texture2D_5( "BushPlane_Bake1_pbrs2a_alpha", 2D ) = "white" {}
		Material_Texture2D_6( "WaveNoiseTexture", 2D ) = "white" {}
