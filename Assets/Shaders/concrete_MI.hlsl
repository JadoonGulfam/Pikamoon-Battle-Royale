...
{
	Material.PreshaderBuffer[0] = float4(6.000000,-0.003906,-0.001793,25.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.498039,0.247059,0.247059,2.000000);//(Unknown)
