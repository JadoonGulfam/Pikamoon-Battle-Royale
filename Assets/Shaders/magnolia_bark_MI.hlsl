...
{
	Material.PreshaderBuffer[0] = float4(12.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,0.040000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-0.013333,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.093750,0.063074,0.058594,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = (Material.PreshaderBuffer[2].xyz * Local7.rgb);
	...
	MaterialFloat3 Local12 = WSMultiplyDemote(DERIV_BASE_VALUE(Local11), GetWorldToLocal(Parameters));
	MaterialFloat3 Local13 = (DERIV_BASE_VALUE(Local12) * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat Local14 = DERIV_BASE_VALUE(Local13).b;
	MaterialFloat3 Local15 = (DERIV_BASE_VALUE(Local12) * ((MaterialFloat3)Material.PreshaderBuffer[3].x));
	MaterialFloat2 Local16 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)3.00000000));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 3);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local16),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 3);
	MaterialFloat3 Local20 = (DERIV_BASE_VALUE(Local15) * Local18.rgb);
	MaterialFloat3 Local21 = (((MaterialFloat3)DERIV_BASE_VALUE(Local14)) + Local20);
	MaterialFloat Local22 = (Local21.x - 1.00000000);
	MaterialFloat Local23 = (Local22 + Material.PreshaderBuffer[3].y);
	...
	MaterialFloat3 Local27 = lerp(Material.PreshaderBuffer[4].xyz,Local9,Local26.r);
	MaterialFloat Local28 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local29 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local30 = MaterialStoreTexSample(Parameters, Local29, 0);
	MaterialFloat Local31 = (Local29.g + 0.33000001);
	MaterialFloat Local32 = (Local22 + 0.00000000);
	...
	MaterialFloat Local36 = lerp(Local31,Local29.g,Local35.r);
