Shader "Unreal/Campfire_Bake1_baked"
{
    Properties
    {
		...
		Material_Texture2D_0( "Campfire_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "Campfire_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Campfire_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_3( "Campfire_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Campfire_Bake1_baked.hlsl"
