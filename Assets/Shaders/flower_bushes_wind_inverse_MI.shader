Shader "Unreal/flower_bushes_wind_inverse_MI"
{
    Properties
    {
		...
		Material_Texture2D_1( "Albedo_Alpha", 2D ) = "white" {}
		Material_Texture2D_2( "AO_Rough_Subsurface", 2D ) = "white" {}
		Material_Texture2D_3( "colour_variation_mask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "flower_bushes_wind_inverse_MI.hlsl"
