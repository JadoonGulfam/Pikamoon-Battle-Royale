...
{
	Material.PreshaderBuffer[0] = float4(1.560562,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.104167,0.104167,0.104167,0.876190);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.619048,0.000000,0.000000,0.000000);//(Unknown)
