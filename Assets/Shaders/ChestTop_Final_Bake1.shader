Shader "Unreal/ChestTop_Final_Bake1"
{
    Properties
    {
		...
		Material_Texture2D_0( "ChestTop_Final_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "ChestTop_Final_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "ChestTop_Final_Bake1_pbr_metalness", 2D ) = "white" {}
		Material_Texture2D_3( "ChestTop_Final_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_4( "ChestTop_Final_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "ChestTop_Final_Bake1.hlsl"
