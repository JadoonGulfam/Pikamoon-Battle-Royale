Shader "Unreal/Winebarrel_Low_Bake1_baked"
{
    Properties
    {
		...
		Material_Texture2D_0( "Winebarrel_Low_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "Winebarrel_Low_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Winebarrel_Low_Bake1_pbr_metalness", 2D ) = "white" {}
		Material_Texture2D_3( "Winebarrel_Low_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_4( "Winebarrel_Low_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Winebarrel_Low_Bake1_baked.hlsl"
