...
{
	Material.PreshaderBuffer[0] = float4(2.000000,-0.003906,-0.000977,25.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,40.344597);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.671875,0.450961,0.391927,-0.000977);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.600000,0.000000,0.000000,0.000000);//(Unknown)
