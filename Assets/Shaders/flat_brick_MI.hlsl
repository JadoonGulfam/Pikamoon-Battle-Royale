...
{
	Material.PreshaderBuffer[0] = float4(1.500000,-0.003906,-0.000977,25.000000);//(Unknown)
	...
	Material.PreshaderBuffer[8] = float4(0.670000,0.000000,0.000000,0.000000);//(Unknown)
