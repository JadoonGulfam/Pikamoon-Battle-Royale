Shader "Unreal/GrassMaterialInstanceSmall"
{
    Properties
    {
		...
		Material_Texture2D_0( "GrassVariation_Texture", 2D ) = "white" {}
		Material_Texture2D_1( "WaveNoiseTexture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "GrassMaterialInstanceSmall.hlsl"
