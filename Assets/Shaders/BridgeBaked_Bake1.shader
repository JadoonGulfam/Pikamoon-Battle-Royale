Shader "Unreal/BridgeBaked_Bake1"
{
    Properties
    {
		...
		Material_Texture2D_0( "BridgeBaked_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "BridgeBaked_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "BridgeBaked_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_3( "BridgeBaked_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "BridgeBaked_Bake1.hlsl"
