Shader "Unreal/BranchMatInstance"
{
    Properties
    {
		...
		Material_Texture2D_0( "Branch_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "Branch_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Branch_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_3( "Branch_Bake1_pbr_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "Branch_Bake1_pbr_sss", 2D ) = "white" {}
		Material_Texture2D_5( "Branch_Bake1_pbr_alpha", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "BranchMatInstance.hlsl"
