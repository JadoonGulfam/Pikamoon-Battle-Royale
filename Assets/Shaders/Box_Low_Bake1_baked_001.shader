Shader "Unreal/Box_Low_Bake1_baked_001"
{
    Properties
    {
		...
		Material_Texture2D_0( "Box_Low_Bake1_pbr_normal", 2D ) = "white" {}
		Material_Texture2D_1( "Box_Low_Bake1_pbr_diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Box_Low_Bake1_pbr_metalness", 2D ) = "white" {}
		Material_Texture2D_3( "Box_Low_Bake1_pbr_specular", 2D ) = "white" {}
		Material_Texture2D_4( "Box_Low_Bake1_pbr_roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Box_Low_Bake1_baked_001.hlsl"
