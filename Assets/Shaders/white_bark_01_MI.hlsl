...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.723958,0.542969,0.542969,-108.766594);//(Unknown)
	Material.PreshaderBuffer[3] = float4(205.534103,182022.656250,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.723055,0.545724,0.545724,0.000000);//(Unknown)
