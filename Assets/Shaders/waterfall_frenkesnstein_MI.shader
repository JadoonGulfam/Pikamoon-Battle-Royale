Shader "Unreal/waterfall_frenkesnstein_MI"
{
    Properties
    {
		...
		Material_Texture2D_0( "water_normal_T", 2D ) = "white" {}
		Material_Texture2D_1( "waterfall_mask_T", 2D ) = "white" {}
		Material_Texture2D_2( "water_spray_ao_rough_metal_T", 2D ) = "white" {}
		Material_Texture2D_3( "cloud_mask_T", 2D ) = "white" {}
		Material_Texture2D_4( "water_ao_rough_metal_T", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "waterfall_frenkesnstein_MI.hlsl"
