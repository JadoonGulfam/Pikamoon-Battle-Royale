Shader "Unreal/water_still_small_MI"
{
    Properties
    {
		...
		Material_Texture2D_1( "water_spray_ao_rough_metal_T", 2D ) = "white" {}
		Material_Texture2D_2( "cloud_mask_T", 2D ) = "white" {}
		Material_Texture2D_3( "water_ao_rough_metal_T", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "water_still_small_MI.hlsl"
